...
```
python scripts/evaluate_mirflickr_huber.py \
...
from diffcam.huber import ReconstructionHuber
...
def mirflickr_dataset(data, n_files, n_iter, single_psf, save):
    ...
    # -- create ADMM object
    recon = ReconstructionHuber(psf_float)
    ...
    for fn in files:
        ...
        est = recon.reconstruction(n_iter=n_iter)
